    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookAuthorsAuthorId = table.Column<int>(type: "integer", nullable: false),
                    BookAuthorsId = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorBook", x => new { x.BookAuthorsAuthorId, x.BookAuthorsId });
                    table.ForeignKey(
                        name: "FK_AuthorBook_Author_BookAuthorsAuthorId",
                        column: x => x.BookAuthorsAuthorId,
                        principalTable: "Author",
                        principalColumn: "AuthorId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AuthorBook_Book_BookAuthorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserBookReservation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserBookReservation_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserBookReservation_BookId",
                table: "UserBookReservation",
                column: "BookId");
        }
